...
class ActionExecutor:
    ...
    def _configuracion(self, params: Dict[str, Any]) -> Dict:
        ...
        intents = {
            ...
            "avion": "android.settings.AIRPLANE_MODE_SETTINGS",
            "modo_avion": "android.settings.AIRPLANE_MODE_SETTINGS",
            "vpn": "android.settings.VPN_SETTINGS",
            "datos": "android.settings.DATA_ROAMING_SETTINGS",
            "datos_moviles": "android.settings.DATA_ROAMING_SETTINGS",
            "hotspot": "android.settings.TETHER_SETTINGS",
            "tethering": "android.settings.TETHER_SETTINGS",
            "cuentas": "android.settings.SYNC_SETTINGS",
            "notificaciones": "android.settings.NOTIFICATION_SETTINGS",
            "privacidad": "android.settings.PRIVACY_SETTINGS",
            "reset": "android.settings.BACKUP_AND_RESET_SETTINGS",
            "input": "android.settings.INPUT_METHOD_SETTINGS",
            "teclado": "android.settings.INPUT_METHOD_SETTINGS",
